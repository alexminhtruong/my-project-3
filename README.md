...
> [!CAUTION] Deadlinen på denna uppgift är en s.k. "hård deadline". Efter deadline går det inte att pusha till repot.

## Att göra i repot

- [x] Öppna filen `vite.config.js` och byt ut `base`-värdet mot ditt repos adress.
- [x] Gå in på Settings-fliken i ditt repo och aktivera GitHub Pages. Välj "GitHub Actions" som alternativ.
- [x] Se till att adressen till din GitHub Pages finns på repots startsida (via kugghjulet).
...
- [x] ![My wireframe for the shop](/assets/wireframe.webp 'My wireframe for the shop')

# HTML-validator

- [x] ![HTML-validate for the shop](/assets/HTML-validator.webp ' HTML-validator for the shop')

# Lighthouse

- [x] ![Accessibility for the shop](/assets/Lighthouse.webp ' Accessibility-validator for the shop')
